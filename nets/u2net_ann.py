...
class U2NET(nn.Module):
    ...
    def __init__(self,in_ch=3,out_ch=1):
        ...
        self.stage5 = Block(512,256,512)
        self.pool56 = nn.MaxPool2d(2,stride=2,ceil_mode=True)

        self.stage6 = Block(512,256,512)

        # decoder
        self.stage5d = Block(1024,256,512)
    ...
    def forward(self,x):
        ...
        return self.Matrix_r(d0), self.Matrix_r(d1), self.Matrix_r(d2), self.Matrix_r(d3), self.Matrix_r(d4), self.Matrix_r(d5), self.Matrix_r(d6)